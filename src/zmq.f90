...
MODULE ZMQ
  ...
  ! ERROR NUMBERS
  INTEGER(KIND = C_INT), BIND(C) :: ENOTSUP
  INTEGER(KIND = C_INT), BIND(C) :: EPROTONOSUPPORT
  INTEGER(KIND = C_INT), BIND(C) :: ENOBUFS
  INTEGER(KIND = C_INT), BIND(C) :: ENETDOWN
  INTEGER(KIND = C_INT), BIND(C) :: EADDRINUSE
  INTEGER(KIND = C_INT), BIND(C) :: EADDRNOTAVAIL
  INTEGER(KIND = C_INT), BIND(C) :: ECONNREFUSED
  INTEGER(KIND = C_INT), BIND(C) :: EINPROGRESS
  INTEGER(KIND = C_INT), BIND(C) :: ENOTSOCK
  INTEGER(KIND = C_INT), BIND(C) :: EMSGSIZE
  INTEGER(KIND = C_INT), BIND(C) :: EAFNOSUPPORT
  INTEGER(KIND = C_INT), BIND(C) :: ENETUNREACH
  INTEGER(KIND = C_INT), BIND(C) :: ECONNABORTED
  INTEGER(KIND = C_INT), BIND(C) :: ECONNRESET
  INTEGER(KIND = C_INT), BIND(C) :: ENOTCONN
  INTEGER(KIND = C_INT), BIND(C) :: ETIMEDOUT
  INTEGER(KIND = C_INT), BIND(C) :: EHOSTUNREACH
  INTEGER(KIND = C_INT), BIND(C) :: ENETRESET
  INTEGER(KIND = C_INT), BIND(C) :: EFSM
  INTEGER(KIND = C_INT), BIND(C) :: ENOCOMPATPROTO
  INTEGER(KIND = C_INT), BIND(C) :: ETERM
  INTEGER(KIND = C_INT), BIND(C) :: EMTHREAD

  ! VERSION NUMBERS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_VERSION_MAJOR
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_VERSION_MINOR
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_VERSION_PATCH
  INTEGER(KIND = C_INT), BIND(C) :: FZMQ_VERSION_MAJOR
  INTEGER(KIND = C_INT), BIND(C) :: FZMQ_VERSION_MINOR
  INTEGER(KIND = C_INT), BIND(C) :: FZMQ_VERSION_PATCH

  ! CONTEXT OPTIONS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IO_THREADS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_MAX_SOCKETS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SOCKET_LIMIT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_THREAD_PRIORITY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_THREAD_SCHED_POLICY

  ! CONTEXT DEFAULTS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IO_THREADS_DFLT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_MAX_SOCKETS_DFLT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_THREAD_PRIORITY_DFLT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_THREAD_SCHED_POLICY_DFLT

  ! SOCKET TYPES
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PAIR
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PUB
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SUB
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_REQ
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_REP
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_DEALER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_ROUTER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PULL
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PUSH
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_XPUB
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_XSUB
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_STREAM

  ! SOCKET OPTIONS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_AFFINITY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IDENTITY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SUBSCRIBE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_UNSUBSCRIBE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_RATE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_RECOVERY_IVL
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SNDBUF
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_RCVBUF
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_RCVMORE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_FD
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENTS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_TYPE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_LINGER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_RECONNECT_IVL
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_BACKLOG
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_RECONNECT_IVL_MAX
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_MAXMSGSIZE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SNDHWM
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_RCVHWM
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_MULTICAST_HOPS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_RCVTIMEO
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SNDTIMEO
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_LAST_ENDPOINT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_ROUTER_MANDATORY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_TCP_KEEPALIVE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_TCP_KEEPALIVE_CNT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_TCP_KEEPALIVE_IDLE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_TCP_KEEPALIVE_INTVL
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IMMEDIATE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_XPUB_VERBOSE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_ROUTER_RAW
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IPV6
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_MECHANISM
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PLAIN_SERVER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PLAIN_USERNAME
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PLAIN_PASSWORD
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_CURVE_SERVER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_CURVE_PUBLICKEY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_CURVE_SECRETKEY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_CURVE_SERVERKEY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PROBE_ROUTER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_REQ_CORRELATE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_REQ_RELAXED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_CONFLATE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_ZAP_DOMAIN
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_ROUTER_HANDOVER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_TOS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_CONNECT_RID
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_GSSAPI_SERVER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_GSSAPI_PRINCIPAL
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_GSSAPI_SERVICE_PRINCIPAL
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_GSSAPI_PLAINTEXT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_HANDSHAKE_IVL
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SOCKS_PROXY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_XPUB_NODROP

  ! MESSAGE OPTIONS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_MORE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SRCFD
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SHARED

  ! SEND/RECV OPTIONS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_DONTWAIT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_SNDMORE

  ! SECURITY MECHANISMS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_NULL
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_PLAIN
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_CURVE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_GSSAPI

  ! EVENTS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_CONNECTED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_CONNECT_DELAYED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_CONNECT_RETRIED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_LISTENING
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_BIND_FAILED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_ACCEPTED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_ACCEPT_FAILED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_CLOSED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_CLOSE_FAILED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_DISCONNECTED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_MONITOR_STOPPED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_EVENT_ALL

  ! POLLING OPTIONS
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_POLLIN
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_POLLOUT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_POLLERR

  ! PROBE CAPABILITIES
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_HAS_CAPABILITIES

  ! DEPRECATED
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_XREQ
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_XREP
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_TCP_ACCEPT_FILTER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IPC_FILTER_PID
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IPC_FILTER_UID
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IPC_FILTER_GID
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_IPV4ONLY
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_DELAY_ATTACH_ON_CONNECT
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_NOBLOCK
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_FAIL_UNROUTABLE
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_ROUTER_BEHAVIOR
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_STREAMER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_FORWARDER
  INTEGER(KIND = C_INT), BIND(C) :: ZMQ_QUEUE
  ...
  INTERFACE
    ...
    END FUNCTION FZMQ_SOCKET_MONITOR
...
CONTAINS
  ...
  END FUNCTION ZMQ_GETSOCKOPT_API
  ...
  END FUNCTION ZMQ_SEND_CONST_API
  ...
  END FUNCTION ZMQ_SEND_CONST_INT
  ...
  FUNCTION ZMQ_SEND_CONST_INT64(SOCKET, VALUE, FLAGS) RESULT(NBYTES)
    ...
    NBYTES = FZMQ_SEND_CONST(SOCKET, C_LOC(VALUE), C_SIZEOF(VALUE), FLAGS)
  END FUNCTION ZMQ_SEND_CONST_INT64
  ...
  END FUNCTION ZMQ_SEND_CONST_STR
  ...
  END FUNCTION ZMQ_SETSOCKOPT_API
